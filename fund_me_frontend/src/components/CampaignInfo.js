        ...
        <div>
          ...
          <div className='col-span-6 sm:col-span-3'>
            ...
            <input
              ...
              className='mt-1 block w-11/12 p-2 border border-black mb-5 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm'
            />
